...
as $$
begin
  delete from public.data_quality_issues where dqi.resolved_at is null;
  ...
  return query
  select dqi.check_id, dqi.severity, dqi.affected_count::int, dqi.description`n  from public.data_quality_issues dqi
